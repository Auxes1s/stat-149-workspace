...
library(glmmTMB)
library(performance)
source("C:\\Users\\admin\\OneDrive - University of the Philippines\\Documents\\show_table.R")
```

```{r}
dat <- read.dta13("C:\\Users\\admin\\Downloads\\PH_2017_DHS_05042023_1428_186917\\PHIR71DT\\PHIR71FL.DTA")
```
